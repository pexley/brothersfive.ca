...
function showFact( $text, $fact ) {
	...
	echo "<td valign=\"top\" colspan=\"2\" class=\"databack\"><span class=\"normal\">$fact&nbsp;</span></td>\n";
	echo "</tr>\n";
}
...
<span class="header"><?php echo "$text[tree]: $row[treename]"?></span><br clear="all" />
<br/>
<?php
echo tng_coreicons();
?>	
...
?>
	...
	<br/>
<?php
	echo "<a href=\"$browsetrees_url" . "tree=$tree\">$text[morestats]</a>\n";
?>
	<br/><br/>
