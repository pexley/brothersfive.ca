...
// Google's own pages.
	echo "<input type=\"button\" onclick=\"return divbox('mapcontainer');\" value=\"$admtext[showhidemap]\" style=\"vertical-align:middle\"> <span class=\"normal\">$admtext[getcoords]</span>\n";

	echo "<div id=\"mapcontainer\" style=\"display:none; border:solid 1px black; width:$map[admw]; padding:5px; margin-bottom:8px; margin-right:10px; margin-top:8px\">\n";
