...
<tr class="databack">
	<td class="tngshadow">
		...
		<p>When you're ready, click on the <strong>Import Data</strong> button to begin the process. You should see a counter tick off every 10 individuals, families, sources and notes imported. A final
		count of all records imported will also be displayed, followed by a "Finished" message.</p>

		<span class="optionhead">"Resume" Feature</span>
		<p>If you do not see the "Finished" message, your data was not properly imported.
		If you do not see any numbers, or if you see numbers but do not see a "Finished" message, your server may have killed your import process for running too long.
		If this happens to you, first publish your GEDCOM to the TNG gedcom folder on your web site if you haven't already. Next, return to the Admin/Setup/Import Settings page
		and check the box next to <strong>Save Import State</strong>. Then return here and try your import again. If the import fails to run to completion, you will now
		be able to click a "resume" link at the top of the page to resume the import. If you do not see the resume link, you can still resume the import by going directly
		to <em>admin/gedimport.php?tree=treeid</em>, where "treeid" is the ID (not the name) of your destination tree.</p>
