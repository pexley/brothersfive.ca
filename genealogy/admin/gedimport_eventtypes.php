...
<?php
$pciteevents = array("NAME","BIRT","CHR","SEX","DEAT","BURI","BAPL","ENDL","SLGC","NICK","NSFX","TITL","CHAN","NPFX","NSFX","FAMC","FAMS","OBJE","IMAGE","NOTE","SOUR");
$fciteevents = array("HUSB","WIFE","MARR","DIV","SLGS","CHAN","CHIL","NOTE","OBJE","SOUR");
$sciteevents = array("ABBR","AUTH","CALN","PUBL","TITL","CHAN","DATA","TEXT","NOTE","OBJE","REPO");
$rciteevents = array("NAME","ADDR","CHAN","NOTE","OBJE");
		...
		if( $lineinfo[level] == 1 ) {
			...
			if(!in_array($tag,$stdarray)) {
				...
				if( !in_array( $thisevent, $custeventlist ) ) {
					...
					if( !$display )
						$display = $admtext[$tag] ? $admtext[$tag] : $tag;
