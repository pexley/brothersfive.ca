...
<?php
	...
	echo displayHeadline("$admtext[reports] &gt;&gt; $admtext[addnewreport]","reports_icon.gif",$menu,$message);
?>

<table width="100%" border="0" cellpadding="10" cellspacing="2" class="lightback">
<tr class="databack">
<td class="tngshadow">
	<form action="addreport.php" style="margin:0px" method="post" name="form1" id="form1" onSubmit="return validateForm();">
	<table>
	...
	<tr><td valign="top"><span class="normal"><?php echo $admtext['rankpriority']; ?>:</span></td><td><input type="text" name="rank" size="3" maxlength="3" value="1"></td></tr>
