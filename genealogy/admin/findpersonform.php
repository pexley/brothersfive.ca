...
<form action="" style="margin:0px;" name="findform1" id="findform1" onsubmit="return openFind(this,'findperson.php');">
...
<input type="submit" value="<?php echo $admtext['search']; ?>"> <img src="../spinner.gif" id="findspin" width="16" height="16" style="display:none">
</form>
