...
<tr class="databack">
<td>
	<span class="subhead"><strong><?php echo $admtext[selectcemaction]; ?></strong>  | <a href="javascript:newwindow=window.open('../<?php echo $helplang; ?>/cemeteries_help.html#find', 'newwindow', 'height=500,width=600,resizable=yes,scrollbars=yes'); newwindow.focus();"><?php echo $admtext[help]; ?></a></span><br/><br/>
	<span class="normal">
	&nbsp;&nbsp;<img src="tng_edit.gif" alt="<?php echo $admtext[edit]; ?>" width="16" height="16" border="0" align="middle"> = <?php echo $admtext[edit]; ?> &nbsp;&nbsp;
	<img src="tng_delete.gif" alt="<?php echo $admtext[text_delete]; ?>" width="16" height="16" border="0" align="middle"> = <?php echo $admtext[text_delete]; ?>
	<br/>
<?php
...
$actionstr = "";
if( $allow_edit )
	$actionstr .= "<a href=\"editcemetery.php?cemeteryID=xxx\"><img src=\"tng_edit.gif\" alt=\"$admtext[edit]\" width=\"16\" height=\"16\" border=\"0\" vspace=0 hspace=2></a>";
if( $allow_delete )
