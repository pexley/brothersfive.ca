...
<?php
	...
	$innermenu .= "<a href=\"javascript:newwindow=window.open('../$helplang/logconfig_help.php', 'newwindow', 'height=500,width=700,resizable=yes,scrollbars=yes'); newwindow.focus();\" class=\"lightlink\">$admtext[help]</a>";
	$menu = doMenu($setuptabs,"log",$innermenu);
	echo displayHeadline("$admtext[setup] &gt;&gt; $admtext[configuration] &gt;&gt; $admtext[logconfigsettings]","setup_icon.gif",$menu,"");
?>

<table width="100%" border="0" cellpadding="10" cellspacing="2" class="lightback">
<tr class="databack">
<td class="tngshadow">
	<form action="updatelogconfig.php" method="post" name="form1">
	<table>
