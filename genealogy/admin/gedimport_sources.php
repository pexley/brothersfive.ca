...
function handleSource( $persfamID, $prevlevel ) {
	global $tree, $lineinfo, $admtext, $custevents, $stdevents, $citations_table, $savestate;
...
function getSourceRecord( $sourceID, $prevlevel ) {
	...
	global $custeventlist, $lineending, $currentuser, $tngimpcfg, $today, $prefix, $allevents;
...
function getRepoRecord( $repoID, $prevlevel ) {
	...
	global $custeventlist, $lineending, $currentuser, $tngimpcfg, $today, $address_table, $prefix, $allevents;
