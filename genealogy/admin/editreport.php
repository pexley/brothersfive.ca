...
$row[sqlselect] = ereg_replace("\"", "&#34;",$row[sqlselect]);
...
$ceresult = mysql_query($query) or die ("$admtext[cannotexecutequery]: $query");
while( $cerow = mysql_fetch_assoc( $ceresult ) ) {
...
?>
<script src="selectutils.js"></script>
...
<?php
	...
	$innermenu = "<a href=\"javascript:newwindow=window.open('../$helplang/reports_help.php#edit', 'newwindow', 'height=500,width=700,resizable=yes,scrollbars=yes'); newwindow.focus();\" class=\"lightlink\">$admtext[help]</a>";
	$menu = doMenu($reporttabs,"edit",$innermenu);
	echo displayHeadline("$admtext[reports] &gt;&gt; $admtext[modifyreport]","reports_icon.gif",$menu,$message);
?>

<table width="100%" border="0" cellpadding="10" cellspacing="2" class="lightback">
<tr class="databack">
<td class="tngshadow">
	<form action="updatereport.php" method="post" name="form1" id="form1" onSubmit="return validateForm();">
	<table>
	<tr><td><span class="normal"><?php echo $admtext['reportname']; ?>:</span></td><td><input type="text" name="reportname" size="50" maxlength="80" value="<?php echo $row['reportname']; ?>"></td></tr>
	...
	<tr><td valign="top"><span class="normal"><?php echo $admtext['rankpriority']; ?>:</span></td><td><input type="text" name="rank" size="3" maxlength="3" value="<?php echo $row['rank']; ?>"></td></tr>
	...
	<img src="tng_right.gif" width="17" height="15" border="0" align="middle"> = <?php echo $admtext['add']; ?> &nbsp;&nbsp;
	<img src="tng_left.gif" width="17" height="15" border="0" align="middle"> = <?php echo $admtext['remove']; ?> &nbsp;&nbsp;
	<img src="tng_up.gif" width="17" height="15" border="0" align="middle"> = <?php echo $admtext['moveup']; ?> &nbsp;&nbsp;
	<img src="tng_down.gif" width="17" height="15" border="0" align="middle"> = <?php echo $admtext['movedown']; ?> &nbsp;&nbsp;</span><br/><br/>
	<p class="subhead"><b><?php echo $admtext['choosedisplay']; ?>:</b></p></td></tr>
	<tr><td valign="top" colspan="2">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top">
						<select name="availfields" size="15" style="width:220px" onDblClick="AddtoDisplay(document.form1.availfields,document.form1.displayfields);">
<?php
...
?>						
					...
					<td width="40" align="center">
						&nbsp;<a href="javascript:AddtoDisplay(document.form1.availfields,document.form1.displayfields);"><img src="tng_right.gif" alt="<?php echo $admtext[add]; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;<a href="javascript:RemovefromDisplay(document.form1.displayfields);"><img src="tng_left.gif" alt="<?php echo $admtext[remove]; ?>" width="17" height="15" border="0"></a>&nbsp;
					</td>
					<td valign="top">
						<select name="displayfields" size="15" style="width:220px" onDblClick="RemovefromDisplay(document.form1.displayfields);">
<?php
...
?>
					...
					<td>
						&nbsp;&nbsp;&nbsp;<a href="javascript:Move(document.form1.displayfields,1);"><img src="tng_up.gif" alt="<?php echo $admtext['moveup']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;&nbsp;&nbsp;<a href="javascript:RemovefromDisplay(document.form1.displayfields);"><img src="tng_left.gif" alt="<?php echo $admtext['remove']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;&nbsp;&nbsp;<a href="javascript:Move(document.form1.displayfields,0);"><img src="tng_down.gif" alt="<?php echo $admtext['movedown']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr><td valign="top" colspan="2">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top">
						<select name="availcriteria" size="12" style="width:220px" onDblClick="AddtoDisplay(document.form1.availcriteria,document.form1.finalcriteria);">
<?php
...
?>						
					...
					<td width="40" align="center">
						&nbsp;<a href="javascript:AddtoDisplay(document.form1.availcriteria,document.form1.finalcriteria);"><img src="tng_right.gif" alt="<?php echo $admtext[add]; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;<a href="javascript:RemovefromDisplay(document.form1.finalcriteria);"><img src="tng_left.gif" alt="<?php echo $admtext[remove]; ?>" width="17" height="15" border="0"></a>&nbsp;
					</td>
					<td valign="top" rowspan="4">
						<select name="finalcriteria" size="28" style="width:220px" onDblClick="RemovefromDisplay(document.form1.finalcriteria);">
<?php
...
?>
					...
					<td width="40" align="center"rowspan="4">
						&nbsp;<a href="javascript:Move(document.form1.finalcriteria,1);"><img src="tng_up.gif" alt="<?php echo $admtext['moveup']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;<a href="javascript:RemovefromDisplay(document.form1.finalcriteria);"><img src="tng_left.gif" alt="<?php echo $admtext['remove']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;<a href="javascript:Move(document.form1.finalcriteria,0);"><img src="tng_down.gif" alt="<?php echo $admtext['movedown']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/><br/><br/><br/><br/><br/><br/>
					</td>
				</tr>
				<tr>
					<td valign="top">
						<span class="normal"><?php echo $admtext[operators]; ?>:<br/></span>
						<select name="availoperators" size="8" style="width:220px" onDblClick="AddtoDisplay(document.form1.availoperators,document.form1.finalcriteria);">
							<option value="=">=</option>
							<option value="!=">!=</option>
							<option value=">">&gt;</option>
							<option value=">=">&gt;=</option>
...
?>						
					...
					<td width="40" align="center">
						&nbsp;<a href="javascript:AddtoDisplay(document.form1.availoperators,document.form1.finalcriteria);"><img src="tng_right.gif" alt="<?php echo $admtext[add]; ?>" width="17" height="15" border="0"></a>&nbsp;
					</td>
				</tr>
				<tr>
					<td valign="top">
					...
					<td width="40" align="center"><br/>
						&nbsp;<a href="javascript:AddConstant(document.form1.constantstring,document.form1.finalcriteria,1);"><img src="tng_right.gif" alt="<?php echo $admtext[add]; ?>" width="17" height="15" border="0"></a>&nbsp;
					</td>
				</tr>
				<tr>
					<td valign="top">
					...
					<td width="40" align="center"><br/>
						&nbsp;<a href="javascript:AddConstant(document.form1.constantvalue,document.form1.finalcriteria,0);"><img src="tng_right.gif" alt="<?php echo $admtext[add]; ?>" width="17" height="15" border="0"></a>&nbsp;
					</td>
				</tr>
			</table>
	...
	<tr><td valign="top" colspan="2">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top">
						<select name="availsort" size="10" style="width:220px" onDblClick="AddtoDisplay(document.form1.availsort,document.form1.finalsort);">
<?php
						foreach( $cfields as $key=>$value )
							echo "<option value=\"$key\">$admtext[$value]</option>\n";
						//now do custom event types, prefix with "ce_"
...
?>
					...
					<td width="40" align="center">
						&nbsp;<a href="javascript:AddtoDisplay(document.form1.availsort,document.form1.finalsort);"><img src="tng_right.gif" alt="<?php echo $admtext[add]; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;<a href="javascript:RemovefromDisplay(document.form1.finalsort);"><img src="tng_left.gif" alt="<?php echo $admtext[remove]; ?>" width="17" height="15" border="0"></a>&nbsp;
					</td>
					<td valign="top">
						<select name="finalsort" size="10" style="width:220px" onDblClick="RemovefromDisplay(document.form1.finalsort);">
<?php
...
?>
					...
					<td width="40" align="center">
						&nbsp;<a href="javascript:Move(document.form1.finalsort,1);"><img src="tng_up.gif" alt="<?php echo $admtext['moveup']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;<a href="javascript:RemovefromDisplay(document.form1.finalsort);"><img src="tng_left.gif" alt="<?php echo $admtext['remove']; ?>" width="17" height="15" border="0"></a>&nbsp;<br/><br/>
						&nbsp;<a href="javascript:Move(document.form1.finalsort,0);"><img src="tng_down.gif" alt="<?php echo $admtext['movedown']; ?>" width="17" height="15" border="0"></a>&nbsp;
					</td>
				</tr>
			</table>
		</td>
	...
	<input type="submit" name="submit" value="<?php echo $admtext[savereport]; ?>">
	</form>
</td>
</tr>
